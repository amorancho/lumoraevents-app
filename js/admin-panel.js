...
function buildEventFormTabs(){
  ...
  tailNodes.forEach((node)=>{
    ...
    if(nodeContainsIds(node,['visible_judges','visible_participants','visible_schedule','visible_results','visible_statistics','show_flags','send_stats_code','hide_judges','has_penalties','has_clubs','hide_school_info','criteria_per_judge','judge_feedback','judges_vis_results','judges_can_change_votes','has_masters','has_registrations','registration_start','registration_end','music_extra_time','registration_fee_cost','registration_finance','registration_not_new_school','registration_not_new_group','min_styles','category_class_type','score_type','criteria_config','total_system','can_decide_positions','restrict_voting','results_filter','tied_positions'])){
...
function rebuildEventDetailTabLayouts(configContent,registrationsContent){
  ...
  const fieldIds=[
    ...
    'registration_finance','registration_not_new_school','registration_not_new_group',
  ...
  appendConfigRow(registrationsContent,[
    fields.registration_finance,fields.registration_not_new_school,fields.registration_not_new_group
  ],'col-12 col-md-4');
...
function populateEventForm(eventObj){
  ...
  ['visible','trial','visible_judges','visible_participants','visible_schedule','visible_results','visible_statistics','has_clubs','hide_school_info','has_penalties','has_registrations','judges_vis_results','judges_can_change_votes','has_masters','show_flags','hide_judges','notice_active','registration_finance','registration_not_new_school','registration_not_new_group'].forEach((id)=>{document.getElementById(id).checked=Number(eventObj[id])===1;});
